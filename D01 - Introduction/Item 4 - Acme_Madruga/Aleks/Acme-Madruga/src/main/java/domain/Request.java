...
public class Request extends DomainEntity {
	...
	/*
	 * public Proccesion getProccesion() {
	 * return this.proccesion;
	 * }
	 * 
	 * public void setProccesion(final Proccesion proccesion) {
	 * this.proccesion = proccesion;
	 * }
	 */
}

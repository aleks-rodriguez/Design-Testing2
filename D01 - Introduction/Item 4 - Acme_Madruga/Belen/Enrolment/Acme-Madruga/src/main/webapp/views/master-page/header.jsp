	...
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('MEMBER')">
			...
			<li><a class="fNiv"><spring:message
						...
						<ul>
						<li class="arrow"></li>
						<li><a href="brotherhood/member/list.do"><spring:message
						code="master.page.brotherhood.list" /></a></li>
						<li><a href="brotherhood/member/listOwn.do"><spring:message
						code="master.page.brotherhood.listOwn" /></a></li>
						<li><a href="brotherhood/member/listDelete.do"><spring:message
		...
		<security:authorize access="hasRole('BROTHERHOOD')">
			...
			<li><a class="fNiv"><spring:message
						...
						<li><a href="member/brotherhood/list.do"><spring:message

...
<form:hidden path="id"/>
	...
	<acme:textbox code="inceptionRecord.title" path="title" readonly="${view}"/>
	<acme:textarea code="inceptionRecord.description" path="description" readonly="${view}"/>
	<acme:textarea code="inceptionRecord.photos" path="photos" readonly="${view}"/>

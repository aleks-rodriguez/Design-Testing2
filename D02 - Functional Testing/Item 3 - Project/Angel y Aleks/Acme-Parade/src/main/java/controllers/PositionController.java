...
public class PositionController extends AbstractController {
	...
	public ModelAndView show(@RequestParam final int idPosition) {
		final ModelAndView result;
		final Position p;
		p = this.servicePosition.findOne(idPosition);
		result = this.createEditModelAndView(p);
		result.addObject("requestURI", "position/administrator/show.do?idPosition" + idPosition);

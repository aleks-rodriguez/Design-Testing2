...
public class CustomisationSystemController extends AbstractController {
	...
	public ModelAndView dashboard() {
		...
		result.addObject("marcadorNumericoArray", this.serviceCustom.marcadorNumerico());
		...
		result.addObject("largestBroHistory", this.serviceCustom.largestBroHistory());
		result.addObject("broMoreRecordThanAVG", this.serviceCustom.broMoreRecordThanAVG());
		result.addObject("chapter10PorcentMoreParadeThanAVG", this.serviceCustom.chapter10PorcentMoreParadeThanAVG());
		result.addObject("paradesFinalModeGroupByStatus", this.serviceCustom.paradesFinalModeGroupByStatus());
		result.addObject("top3", this.serviceCustom.top3());
		return result;

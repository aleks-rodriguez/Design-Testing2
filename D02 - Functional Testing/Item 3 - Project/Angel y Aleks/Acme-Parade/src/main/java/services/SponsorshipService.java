...
public class SponsorshipService {
	...
	public Sponsorship createSponsorship(final Sponsor sponsor, final Parade parade) {
		...
		Assert.isTrue(!(this.sponsorshipRepository.getParadesBySponsor(this.serviceActor.findSponsorByUserAccount(LoginService.getPrincipal().getId()).getId()).contains(parade)), "You don�t have access");
		result.setUrlBanner("");
	...
	public Sponsorship save(final Sponsorship sponsorship) {
		...
		if (sponsorship.getId() != 0)
			Assert.isTrue(logged.getSponsorship().contains(sponsorship), "You don�t have access");
	...
	public void delete(final int id) {
		...
		Assert.isTrue(s.getSponsorship().contains(desactive), "You don�t have access");
	...
	public void reactivate(final int id) {
		...
		Assert.isTrue(esponsor.getSponsorship().contains(reactivate), "You don�t have access");

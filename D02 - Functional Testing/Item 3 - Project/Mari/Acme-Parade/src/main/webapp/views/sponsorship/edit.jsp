...
<form:hidden path="id"/>
	...
	<acme:textbox code="sponsorship.creditCard" path="creditCard" readonly="${view}"/>
	<jstl:if test="${not view}">
	<acme:submit name="save" code="sponsorship.save"/>
	</jstl:if>
</form:form>
<input type="submit" onclick="window.history.back()" value="<spring:message code="sponsorship.cancel"/>"/>
...
lock tables, create view, create routine, alter routine, execute, trigger, show view on `Acme-HackerRank`.* to 'acme-manager'@'%';
...
INSERT INTO `customisation_system` VALUES (14,0,'https://i.imgur.com/7b8lu4b.png',24,'Welcome to Acme-HackerRank! We\'re IT hacker\'s favourite job marketplace!.  ¡Bienvenidos a Acme-HackerRank! ¡Somos el mercado de trabajo favorito de los profesionales de las TICs!',34,10,'Acme-HackerRank');
...
CREATE TABLE `hacker` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_n87ptb5pq45dkfm79ew8fb82b` (`user_account_id`),
  KEY `FK_eohjws41xqofou03dl7t7aku4` (`finder`),
  CONSTRAINT `FK_n87ptb5pq45dkfm79ew8fb82b` FOREIGN KEY (`user_account_id`) REFERENCES `user_account` (`id`),
...
-- Dump completed on 2019-04-25 12:42:27
commit;

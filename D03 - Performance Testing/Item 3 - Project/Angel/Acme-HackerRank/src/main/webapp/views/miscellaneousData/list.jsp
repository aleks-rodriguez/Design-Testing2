...
<display:table name="miscDatas" id="row" requestURI="${requestURI}"
	...
	<display:column titleKey="misc.show">
		<security:authorize access="hasRole('HACKER')">
			<a href="miscData/hacker/show.do?id=${row.id}"><spring:message
					code="misc.show" /></a>
		</security:authorize>
	...
	<security:authorize access="hasRole('HACKER')">
		<display:column titleKey="misc.edit">
			<a href="miscData/hacker/edit.do?id=${row.id}"><spring:message
					code="misc.edit" /></a>
		</display:column>
	</security:authorize>
</display:table>
<security:authorize access="hasRole('HACKER')">
	<jstl:if test="${check}">
		<a href="miscData/hacker/create.do?curricula=${param['id']}"><spring:message
				code="misc.create" /></a>
	</jstl:if>
</security:authorize>
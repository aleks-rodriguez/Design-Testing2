...
<display:table name="eduDatas" id="row" requestURI="${requestURI}"
	...
	<display:column titleKey="eduData.show">
		<security:authorize access="hasRole('HACKER')">
			<a href="educationData/hacker/show.do?id=${row.id}"><spring:message
					code="eduData.show" /></a>
		</security:authorize>
	...
	<security:authorize access="hasRole('HACKER')">
		<display:column titleKey="eduData.edit">
			<a href="educationData/hacker/edit.do?id=${row.id}"><spring:message
					code="eduData.edit" /></a>
		</display:column>
	</security:authorize>
</display:table>
<security:authorize access="hasRole('HACKER')">
	<jstl:if test="${check}">
		<a href="educationData/hacker/create.do?curricula=${param['id']}"><spring:message

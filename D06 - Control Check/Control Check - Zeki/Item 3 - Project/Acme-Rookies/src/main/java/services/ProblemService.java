...
@Service
@Transactional
public class ProblemService extends AbstractService {
	...
	public Collection<Problem> getProblemByPositionId(final int idPosition) {
		return this.problemRepository.getProblemByPositionId(idPosition);
	}

	public Collection<Position> getPositionForProblem(final int idCompany) {
		return this.problemRepository.getPositionForProblem(idCompany);
	}
